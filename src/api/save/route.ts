...
async function upsertStatementSettings(tx: any, userId: string, startDate?: string | null, endDate?: string | null) {
    ...
    const dataToUpdate: { statementStartDate?: Date | null, statementEndDate?: Date | null } = {};
...
export async function POST(request: Request) {
  ...
  try {
    ...
    await prisma.$transaction(async (tx) => {
        ...
        await upsertStatementSettings(tx, userId, startDate, endDate);
    });
