...
>(({ className, onClick, children, ...props }, ref) => {
  ...
  return (
     <Button
        ...
        variant="ghost"
        size="icon"
        className={cn("h-8 w-8 shrink-0 md:h-[1.1rem] md:w-[1.1rem]", isMobile && "md:hidden")}
    ...
    return (
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent side="right" align="center" sideOffset={10} className="max-w-[150px] text-xs">
              {tooltipContent}
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
...
const SidebarMenuSubButton = React.forwardRef<
  HTMLAnchorElement, // Assuming this is primarily used with <a> tags as Link children
...
export {
  Sidebar, SidebarContent, SidebarFooter, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarHeader, SidebarInput, SidebarInset, SidebarMenu, SidebarMenuAction, SidebarMenuBadge, SidebarMenuButton, SidebarMenuItem, SidebarMenuSkeleton, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, SidebarProvider, SidebarRail, SidebarSeparator, SidebarTrigger, useSidebar,
}
