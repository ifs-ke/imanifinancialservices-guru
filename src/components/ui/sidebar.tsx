...
import { Menu, PanelLeft } from "lucide-react" // Import Menu icon
  ...
  (
    ...
    return (
      <div
        ...
        data-state={state}
        data-collapsible={collapsible} // Pass collapsible type
      ...
      >
        ...
        <div
          className={cn(
            ...
            "w-[--sidebar-width]", // Fallback or none
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] ease-linear md:flex",
             // Positioning and width based on side, state and collapsible type
             side === "left" ? (
                 ...
                 collapsible === 'offcanvas' ? "left-[calc(var(--sidebar-width)*-1)] w-[--sidebar-width]" :
                 ...
                 collapsible === 'offcanvas' ? "right-[calc(var(--sidebar-width)*-1)] w-[--sidebar-width]" :
    ...
    <main
      ...
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background",
         // Simplified logic for inset margins based on peer state
  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: // Added secondary variant styling (distinct from active)
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
         active: // New variant for active state
...
>(
  (
    ...
    // Apply 'active' variant if isActive is true, otherwise use the passed variant or default
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant: finalVariant, size }), className)} // Use finalVariant
        {...props}
      />
    )
